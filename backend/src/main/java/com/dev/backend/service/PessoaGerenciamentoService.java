...
public class PessoaGerenciamentoService {
    ...
    public String solicitarCodigo(String email) {
        ...
        emailService.enviarEmailTexto(pessoa.getEmail(), "Código de Recuperação de Senha",
                "Olá, o seu código de recuperação de senha é o seguinte: " + pessoa.getCodigoRecuperacaoSenha());
    ...
    public String alterarSenha(Pessoa pessoa) {
        ...
        if (diferenca.getTime()/1000 <= 900) {
            //depois que adicionar o spring security é necessário criptografar
